...
var text_ans =
    '<h1>#行为艺术</h1>' + 
    '<p>【本回答为脚本自动生成】</p>' +
    '澕為员工离职后被诬告羁押251天，事件发酵后在资泘先是被降热度——明明关注量是热榜第一的十多倍，却只能排到十多名——最后直接被删问题了。我也理解资泘说自己收到了律师函。可是第一，相关内容真的侵犯澕為的<b>合法</b>权益了吗？真的违反法律法规了吗？第二，即使真的澕為法务部门太厉害资泘没办法，用户自发以资泘删不过来的速度发布内容，总不是资泘的错了吧，总不会被澕為告了吧(是吗?)。<br/>' +
